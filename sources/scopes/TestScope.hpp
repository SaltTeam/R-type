...
namespace Scopes {
    ...
    public:
        ...
        {
            scope->entityManager.add<Entities::LeftPart>(LAYER::Layer1, true, x, y + 131);
            scope->entityManager.add<Entities::MiddlePart>(LAYER::Layer1, true, x + 16, y);
            scope->entityManager.add<Entities::RightPart>(LAYER::Layer1, true, x + 200, y + 131);
        }

        void initialize() override {
            this->entityManager.add<Entities::SpeedPowerUp>(LAYER::Layer1, GOLD, 100, 0);
            this->entityManager.add<Entities::YWing>(LAYER::Layer1, true, 250, 600);
            this->entityManager.add<Entities::TieBomber>(LAYER::Layer1);
