...
namespace Scopes
{
    ...
    public:
        ...
        void initialize() override
        {
            ...
            {
                this->entityManager.add<Entities::TieExperiment>(LAYER::Layer3,
        ...
        {
            scope->entityManager.add<Entities::LeftPart>(LAYER::Layer3,
                                                         network::protocol::Update::Master,
                                                         250, true, x, y + 131);
            scope->entityManager.add<Entities::MiddlePart>(LAYER::Layer3,
                                                           network::protocol::Update::Master,
                                                           250, true, x + 16,
                                                           y);
            scope->entityManager.add<Entities::RightPart>(LAYER::Layer3,
                                                          network::protocol::Update::Master,
                                                          250, true, x + 200,
                                                          y + 131);
        }
        ...
        void update() override
        {
            ...
            {
                this->entityManager.add<Entities::TieFigther>(LAYER::Layer3,
                                                              network::protocol::Update::Master,
                                                              250, true, 100,
                                                              100);
                this->entityManager.add<Entities::TieFigther>(LAYER::Layer3,
            ...
            } else
            {
                ...
                if (ennemy_ship == 0 && in == false)
                {
                    ...
                    {
                        this->entityManager.add<Entities::TieExperiment>(
                            LAYER::Layer3, network::protocol::Update::Master,
                            250, true, 150, 300);
                        this->entityManager.add<Entities::TieExperiment>(
                            LAYER::Layer3, network::protocol::Update::Master,
                            250, true, 450, 300);
