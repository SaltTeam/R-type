...
namespace Entities {
    ...
    public:
        SpeedPowerUp(SCOPE *scope, uint64_t id, GRADE grade, int x, int y)
            ...
            switch (grade) {
                case BRONZE:
                    this->setTexture("resources/sprites/Power-ups/bolt_bronze.png");
                    break;
                case SILVER:
                    this->setTexture("resources/sprites/Power-ups/bolt_silver.png");
                    break;
                case GOLD:
                    this->setTexture("resources/sprites/Power-ups/bolt_gold.png");
                    break;
            }
