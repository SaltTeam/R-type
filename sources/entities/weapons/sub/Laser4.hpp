...
namespace Entities {
    ...
    public:
        Laser4(SCOPE *scope, Entities::Ship::TEAM originTeam)
                : AWeapon(scope, "resources/sprites/Lasers/laser" + Entities::Weapon::getColorOfProjectile(originTeam) + "11.png", 0.3, 12, 0, -0.4f, originTeam, network::protocol::Type::LASER4) {}
