    ...
    public:
        YWing(SCOPE *scope, uint64_t id, network::protocol::PlayerColor playerColor,
              ...
              bool isEnabled = true, const float x = 0, const float y = 0)
                : PlayerShip(scope, id, playerColor, updateType, refreshTime, isEnabled, x, y, 0.15, 0.15, 250, 25) {
            this->registerTexture("resources/sprites/ships/player/ship2/" + this->getColorString() + ".png", 0.45);
