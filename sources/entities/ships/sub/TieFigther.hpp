...
namespace Entities {
    ...
    public:
        TieFigther(SCOPE *scope, uint64_t id, network::protocol::PlayerColor playerColor,
            ...
            this->type = network::protocol::Type::SHIP_TIEFIGHTER;
        ...
        void update() override {
            ...
            this->shoot();
            Ship::update();
            if (this->position.x <= 0 || this->position.x + this->texture->sprite.getGlobalBounds().width >=
